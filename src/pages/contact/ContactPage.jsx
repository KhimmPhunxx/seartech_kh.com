      ...
      <div className='max-w-7xl mx-auto z-30 flex justify-between'>
        <div className='w-[48%] z-30 p-20 px-32 space-y-16 bg-blue-600 border-[10px] border-white rounded-tr-[30%]  mt-[-150px]'>
            ...
            <div className=' space-y-4'> 
              ...
              <p className='text-xl text-gray-300'>Monday - Sunday : 8 AM - 6 PM </p>
            </div>
            ...
            <div className=' space-y-4'> 
              ...
              <p className='text-xl text-gray-300'> 099808088 </p>
            </div>
            ...
            <div className='flex space-x-5'> 
              <NavLink >
                 <FaTelegram className='text-3xl text-gray-300 hover:text-white' />
              </NavLink>
              <NavLink target='_blank' to={'https://www.facebook.com/profile.php?id=61556792725526&mibextid=hu50Ix'}>
                 <FaFacebook className='text-3xl text-gray-300 hover:text-white' />
              </NavLink>
              <NavLink >
          ...
          <div className='w-full h-full'>
            ...
            <div className='mt-10'>
              <form className='space-y-8'>
                ...
                <div>
                  <button type='submit' className='w-full p-5 bg-blue-600 text-white rounded-md'>Send Message</button>
                </div>
              </form>
            </div>
          </div>
