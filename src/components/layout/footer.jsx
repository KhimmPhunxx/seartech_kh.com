...
function FooterBar() {
  return (
    <footer className=' -full bg-black py-5'>  
      <section className='max-w-7xl mx-auto h-full py-6 border-b'>
          <h1 className='text-2xl font-bold text-gray-100 border-b pb-2'>SearTechKh</h1>
          <div className='grid md:grid-cols-3 w-full h-full mt-3'>
            <div className='h-full space-y-2'>
                <h1 className='text-lg text-gray-200'>Conatct</h1>
                <div className='space-y-1'>
                    <div className='text-gray-400 flex space-x-2'><IoMail className='mt-1'/> <p>example@gmail.com </p></div>
                    <div className='text-gray-400 flex space-x-2'><IoCall className='mt-1'/> <p>014 417 125 </p></div>
                    <div className='text-gray-400 flex space-x-2'><IoLocation className='mt-1'/> <p>Cambodia, Phnom Penh </p></div>
                </div>
                <div className='flex space-x-4'>
                  <NavLink to={'/'} className='text-gray-300'><FaTelegram className='text-3xl' /></NavLink>
                  <NavLink to={'/'} className='text-gray-300'><FaFacebook className='text-3xl' /></NavLink>
                  <NavLink to={'/'} className='text-gray-300'><FaInstagram className='text-3xl' /></NavLink>
                </div>
            </div>
            <div className='h-full space-y-2'>
